...
<head><script src="//archive.org/includes/analytics.js?v=cf34f82" type="text/javascript"></script>
    ...
    <link rel="alternate" type="application/rss+xml" title="Strategy Station Ltd » フィード" href="<?= home_url(); ?>/feed/"/>
    <link rel="alternate" type="application/rss+xml" title="Strategy Station Ltd » コメントフィード" href="<?= home_url(); ?>/comments/feed/"/>
    <link rel="alternate" type="application/rss+xml" title="Strategy Station Ltd » Home のコメントのフィード" href="<?= home_url(); ?>/%e3%83%9b%e3%83%bc%e3%83%a0/feed/"/>
        ...
        <div id="donato" style="position:relative;width:100%;">
            ...
            <div id="wm-toolbar" style="position:relative;display:flex;flex-flow:row nowrap;justify-content:space-between;">
                ...
                <div class="c" style="display:flex;flex-flow:column nowrap;justify-content:space-between;flex:1;">
                    <form class="u" style="display:flex;flex-direction:row;flex-wrap:nowrap;" target="_top" method="get" action="/web/submit" name="wmtb" id="wmtb"><input type="text" name="url" id="wmtbURL" value="<?= home_url(); ?>/" onfocus="this.focus();this.select();" style="flex:1;"/><input type="hidden" name="type" value="replay" /><input type="hidden" name="date" value="20211102041247" /><input type="submit" value="Go" />
                    </form>
                    <div style="display:flex;flex-flow:row nowrap;align-items:flex-end;">
                        <div class="s" id="wm-nav-captures" style="flex:1;">
                            <a class="t" href="/web/20211102041247*/<?= home_url(); ?>/" title="See a list of every capture for this URL">7 captures</a>
                ...
                <div class="n">
                    <table>
                        ...
                        <tr class="m">
                            <td class="b" nowrap="nowrap"><a href="<?= home_url(); ?>/" title="03 May 2019"><strong>May</strong></a></td>
                            <td class="c" id="displayMonthEl" title="You are here: 04:12:47 Nov 02, 2021">NOV</td>
                            <td class="f" nowrap="nowrap"><a href="<?= home_url(); ?>/" title="25 Dec 2021"><strong>Dec</strong></a></td>
                        </tr>
                        <!-- NEXT/PREV CAPTURE NAV AND DAY OF MONTH INDICATOR -->
                        <tr class="d">
                            <td class="b" nowrap="nowrap"><a href="<?= home_url(); ?>/" title="08:16:49 May 03, 2019"><img src="/_static/images/toolbar/wm_tb_prv_on.png" alt="Previous capture" width="14" height="16" border="0" /></a></td>
                            ...
                            <td class="f" nowrap="nowrap"><a href="<?= home_url(); ?>/" title="17:54:23 Dec 25, 2021"><img src="/_static/images/toolbar/wm_tb_nxt_on.png" alt="Next capture" width="14" height="16" border="0" /></a></td>
                        </tr>
                        <!-- NEXT/PREV YEAR NAV AND YEAR INDICATOR -->
                        <tr class="y">
                            <td class="b" nowrap="nowrap"><a href="<?= home_url(); ?>/" title="03 May 2019"><strong>2019</strong></a></td>
           ...
           <span id="wm-save-snapshot-in-progress" class="iconochive-web"></span>
                    ...
                    <div id="wm-share" class="xxs">
                        <a href="/web/20211102041247/<?= home_url(); ?>/"
                           id="wm-screenshot"
                           title="screenshot">
                        ...
                        <a id="wm-share-facebook" href="#" data-url="<?= home_url(); ?>/" title="Share on Facebook" style="margin-right:5px;" target="_blank"><span class="iconochive-facebook" style="color:#3b5998;font-size:160%;"></span></a>
                        <a id="wm-share-twitter" href="#" data-url="<?= home_url(); ?>/" title="Share on Twitter" style="margin-right:5px;" target="_blank"><span class="iconochive-twitter" style="color:#1dcaff;font-size:160%;"></span></a>
                    </div>
            ...
            </div></div></div></div><div id="wm-ipp-print">The Wayback Machine - <?= home_url(); ?>/</div>
<script type="text/javascript">//<![CDATA[
    __wm.bt(675,27,25,2,"web","<?= home_url(); ?>/","20211102041247",1996,"/_static/",["/_static/css/banner-styles.css?v=fantwOh2","/_static/css/iconochive.css?v=qtvMKcIJ"], false);
    __wm.rw(1);
    //]]></script>
            ...
            <div class="row">
                <div class="col-md-4 clearfix kad-header-left">
                    <div id="logo" class="logocase">
                        <a class="brand logofont" href="<?= home_url(); ?>/">
                            <div id="thelogo">
                                <img src="<?= get_template_directory_uri(); ?>/assets/images/400dpiLogoCropped.jpg" alt="Strategy Station Ltd" class="kad-standard-logo"/>
                            </div>
                        </a>
                ...
                <div class="col-md-8 kad-header-right">
                    <nav id="nav-main" class="clearfix" role="navigation">
                        <ul id="menu-glovalnavigation" class="sf-menu"><li class=" current-menu-item current_page_item menu-item-790"><a href="<?= home_url(); ?>/" aria-current="page"><span>Home</span></a></li>
                            <li class=" sf-dropdown menu-item-601"><a href="<?= home_url(); ?>/company/"><span>Company profile</span></a>
                                <ul class="sub-menu sf-dropdown-menu dropdown">
                                    <li class=" menu-item-610"><a href="<?= home_url(); ?>/company/about-us/"><span>About Strategy Station</span></a></li>
                                    <li class=" menu-item-609"><a href="<?= home_url(); ?>/company/regulation-and-licensing/"><span>Regulation and Licensing</span></a></li>
                                    <li class=" menu-item-605"><a href="<?= home_url(); ?>/company/legal-documents/"><span>Legal Documents</span></a></li>
                                </ul>
                            </li>
                            <li class=" sf-dropdown menu-item-603"><a href="<?= home_url(); ?>/trading/"><span>Trading Conditions</span></a>
                                <ul class="sub-menu sf-dropdown-menu dropdown">
                                    <li class=" menu-item-602"><a href="<?= home_url(); ?>/trading-platforms/"><span>Trading Platforms</span></a></li>
                                </ul>
                            </li>
                            <li class=" sf-dropdown menu-item-613"><a href="<?= home_url(); ?>/company/partnerships-2/"><span>Partnerships</span></a>
                                <ul class="sub-menu sf-dropdown-menu dropdown">
                                    <li class=" menu-item-607"><a href="<?= home_url(); ?>/company/introducing-broker/"><span>Introducing Broker</span></a></li>
                                </ul>
                            </li>
                            <li class=" menu-item-604"><a href="<?= home_url(); ?>/customersupport/contactus-en/"><span>Contact us</span></a></li>
                            <li class=" menu-item-861"><a href="https://client.strategy-sta.com/ss/login.html"><span>LOGIN</span></a></li>
                        </ul>           </nav>
                </div> <!-- Close menuclass-->
            ...
            <div id="kad-mobile-nav" class="kad-mobile-nav">
                <div class="kad-nav-inner mobileclass">
                    <div class="kad-nav-collapse">
                        <ul id="menu-glovalnavigation-1" class="kad-mnav"><li class=" current-menu-item current_page_item menu-item-790"><a href="<?= home_url(); ?>/" aria-current="page"><span>Home</span></a></li>
                            <li class=" sf-dropdown menu-item-601"><a href="<?= home_url(); ?>/company/"><span>Company profile</span></a>
                                <ul class="sub-menu sf-dropdown-menu dropdown">
                                    <li class=" menu-item-610"><a href="<?= home_url(); ?>/company/about-us/"><span>About Strategy Station</span></a></li>
                                    <li class=" menu-item-609"><a href="<?= home_url(); ?>/company/regulation-and-licensing/"><span>Regulation and Licensing</span></a></li>
